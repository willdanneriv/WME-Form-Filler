...
(function () {
    ...
    */
    function formfiller_bootstrap() {
        ...
        // Return early to prevent the legacy setTimeout loop from running
        return;

        /* Original logic for bootstrap
        kept here for functional reference...
        */
    ...
    function formfiller_init() {
        ...
        // We disable the body so it doesn't try to inject the old UI
        return;

        /* Original logic for tab creation and W.selectionManager.events
        kept here for functional reference...
        */
    ...
    */
    function ff_addUserTab() {
        ...
        /* Original logic for ff_addUserTab
        kept here for functional reference...
        */
